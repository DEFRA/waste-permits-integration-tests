Feature: Tests to check Standard rules which are applicable online and SR's which are applicable for download form
  ...
  Scenario: As a user, I should be able to download the forms for the offline permit category and I should be able to fill the forms online for the online permit
    ...
    And I check 3,926 on Cost and processing time page
    And I confirm I meet the rules https://www.gov.uk/government/publications/sr2015-no13-75kte-vehicle-storage-depollution-and-dismantling-authorised-treatment-facility
    #go back
    ...
    And I check 3,926 on Cost and processing time page
    And I confirm I meet the rules https://www.gov.uk/government/publications/sr2015-no14-75kte-metal-recycling-site
    #go back
    And I select a different permit from the task list page
    And I select Standard rules as the permit type
    And I select Deposit for recovery as the permit category
    And I select SR2015 No 39 as the permit number
    And I check 3,872 on Cost and processing time page
    And I confirm I meet the rules https://www.gov.uk/government/publications/sr2015-no39-use-of-waste-in-a-deposit-for-recovery-operation
    #go back
    And I select a different permit from the task list page
    And I select Standard rules as the permit type
    And I select Composting, sewage or sludge treatment, biogas as the permit category
    ...
    And I confirm I meet the rules https://www.gov.uk/government/publications/sr2010-no14-500t-composting-biodegradable-waste
    #go back
    And I select a different permit from the task list page
    And I select Standard rules as the permit type
    ...
    And I check 2,641 on Cost and processing time page
    And I confirm I meet the rules https://www.gov.uk/government/publications/sr2012-no12-anaerobic-digestion-facility-including-use-of-the-resultant-biogas-waste-recovery-operation
    #go back
    And I select a different permit from the task list page
    And I select Standard rules as the permit type
    And I select Anaerobic digestion including storing digestate as the permit category
    ...
    And I check 2,641 on Cost and processing time page
    And I confirm I meet the rules https://www.gov.uk/government/publications/sr2012-no10-on-farm-anaerobic-digestion-facility-using-farm-wastes-only-including-use-of-the-resultant-biogas
    #go back
    And I select a different permit from the task list page
    And I select Standard rules as the permit type
    And I select Car and vehicle dismantling as the permit category
    ...
    And I check 3,926 on Cost and processing time page
    And I confirm I meet the rules https://www.gov.uk/government/publications/sr2015-no18-metal-recycling-vehicle-storage-depollution-and-dismantling-facility 
    #go back
    And I select a different permit from the task list page
    And I select Standard rules as the permit type
    And I select Car and vehicle dismantling as the permit category
    ...
    And I check 3,926 on Cost and processing time page
    And I confirm I meet the rules https://www.gov.uk/government/publications/sr2015-no17-vehicle-storage-depollution-and-dismantling-authorised-treatment-facility
    #go back
    And I select a different permit from the task list page
    And I select Standard rules as the permit type
    And I select Composting, sewage or sludge treatment, biogas as the permit category
    ...
    And I check 2,641 on Cost and processing time page
    And I confirm I meet the rules https://www.gov.uk/government/publications/sr2011-no1-500t-composting-biodegradable-waste-in-open-and-closed-systems
#go back
    And I select a different permit from the task list page
    And I select Standard rules as the permit type
    And I select Composting, sewage or sludge treatment, biogas as the permit category
    ...
    And I check 2,641 on Cost and processing time page
    And I confirm I meet the rules https://www.gov.uk/government/publications/sr2012-no3-composting-in-closed-systems
    #go back
    And I select a different permit from the task list page
    And I select Standard rules as the permit type
    And I select Composting, sewage or sludge treatment, biogas as the permit category
    ...
    And I check 2,641 on Cost and processing time page
    And I confirm I meet the rules https://www.gov.uk/government/publications/sr2012-no7-composting-in-open-systems
    #go back
    And I select a different permit from the task list page
    And I select Standard rules as the permit type
    And I select Composting, sewage or sludge treatment, biogas as the permit category
    ...
    And I check 3,926 on Cost and processing time page
    And I confirm I meet the rules https://www.gov.uk/government/publications/sr2015-no12-75kte-non-hazardous-mechanical-biological-aerobic-treatment-facility
#go back
    And I select a different permit from the task list page
    And I select Standard rules as the permit type
    And I select Composting, sewage or sludge treatment, biogas as the permit category
    ...
    And I check 2,641 on Cost and processing time page
    And I confirm I meet the rules https://www.gov.uk/government/publications/sr2008-no19-250kte-non-hazardous-sludge-biological-chemical-and-physical-treatment-site
    #go back
    And I select a different permit from the task list page
    And I select Standard rules as the permit type
    And I select Composting, sewage or sludge treatment, biogas as the permit category
    ...
    And I check 2,641 on Cost and processing time page
    And I confirm I meet the rules https://www.gov.uk/government/publications/sr2008-no19-75kte-non-hazardous-sludge-biological-chemical-and-physical-treatment-site
    #go back
    And I select a different permit from the task list page
    And I select Standard rules as the permit type
    And I select Deposit for recovery as the permit category
...
#go back
    ...
    And I check 3,926 on Cost and processing time page
    And I confirm I meet the rules https://www.gov.uk/government/publications/sr2015-no16-metal-recycling-site
#go back
    And I select a different permit from the task list page
    And I select Standard rules as the permit type
    And I select Metal recycling, scrap metal and WEEE - not cars or vehicles as the permit category
    ...
    And I check 3,926 on Cost and processing time page
    And I confirm I meet the rules https://www.gov.uk/government/publications/sr2008-no22-75kte-storage-of-furnace-ready-scrap-metal-for-recovery 
    #go back
    And I select a different permit from the task list page
    And I select Standard rules as the permit type
    And I select Metal recycling, scrap metal and WEEE - not cars or vehicles as the permit category
    ...
    And I check 3,926 on Cost and processing time page
    And I confirm I meet the rules https://www.gov.uk/government/publications/sr2009-no7-storage-of-furnace-ready-scrap-metal-for-recovery
    #go back
    And I select a different permit from the task list page
    And I select Standard rules as the permit type
    And I select Metal recycling, scrap metal and WEEE - not cars or vehicles as the permit category
    ...
    And I check 3,926 on Cost and processing time page
    And I confirm I meet the rules https://www.gov.uk/government/publications/sr2015-no15-75kte-weee-authorised-treatment-facility-excluding-ozone-depleting-substances
#go back
    And I select a different permit from the task list page
    And I select Standard rules as the permit type
    And I select Mining, oil and gas as the permit category
    ...
    And I check 2,641 on Cost and processing time page
    And I confirm I meet the rules https://www.gov.uk/government/publications/sr2014-no-2-the-management-of-extractive-waste
    #go back
    And I select a different permit from the task list page
    And I select Standard rules as the permit type
    ...
    And I check 2,641 on Cost and processing time page
    And I confirm I meet the rules https://www.gov.uk/government/publications/sr2010-no4-mobile-plant-for-land-spreading
    #go back
    And I select a different permit from the task list page
    And I select Standard rules as the permit type
    And I select Mobile plant for land-spreading or treatment as the permit category
    ...
    And I check 2,641 on Cost and processing time page
    And I confirm I meet the rules https://www.gov.uk/government/publications/sr2010-no6-mobile-plant-for-land-spreading-of-sewage-sludge
#go back
    And I select a different permit from the task list page
    And I select Standard rules as the permit type
    And I select Mobile plant for land-spreading or treatment as the permit category
    ...
    And I check 2,641 on Cost and processing time page
    And I confirm I meet the rules https://www.gov.uk/government/publications/sr2010-no5-mobile-plant-for-reclamation-restoration-or-improvement-of-land
    #go back
    And I select a different permit from the task list page
    And I select Standard rules as the permit type
    And I select Mobile plant for land-spreading or treatment as the permit category
    ...
    And I check 2,641 on Cost and processing time page
    And I confirm I meet the rules https://www.gov.uk/government/publications/standard-rules-sr2008-number-27
    #go back
    And I select a different permit from the task list page
    And I select Standard rules as the permit type
    And I select Mobile plant for land-spreading or treatment as the permit category
    ...
    And I check 2,641 on Cost and processing time page
    And I confirm I meet the rules https://www.gov.uk/government/publications/sr2010-number-11
#go back
    And I select a different permit from the task list page
    And I select Standard rules as the permit type
    And I select Storage or treatment of waste - recycling, dredgings, clinical, soil or wood treatment as the permit category
    ...
    And I check 3,926 on Cost and processing time page
    And I confirm I meet the rules https://www.gov.uk/government/publications/sr2015-no21-75kte-materials-recycling-facility
    #go back
    And I select a different permit from the task list page
    And I select Standard rules as the permit type
    And I select Storage or treatment of waste - recycling, dredgings, clinical, soil or wood treatment as the permit category
    ...
    And I check 2,641 on Cost and processing time page
    And I confirm I meet the rules https://www.gov.uk/government/publications/sr2010-no18-storage-and-treatment-of-dredgings-for-recovery 
    #go back
    And I select a different permit from the task list page
    And I select Standard rules as the permit type
    And I select Storage or treatment of waste - recycling, dredgings, clinical, soil or wood treatment as the permit category
    ...
    And I check 2,641 on Cost and processing time page
    And I confirm I meet the rules https://www.gov.uk/government/publications/sr2010-no17-storage-of-digestate-from-anaerobic-digestion-plants
#go back
    And I select a different permit from the task list page
    And I select Standard rules as the permit type
    And I select Storage or treatment of waste - recycling, dredgings, clinical, soil or wood treatment as the permit category
    ...
    And I check 2,641 on Cost and processing time page
    And I confirm I meet the rules https://www.gov.uk/government/publications/sr2013-no-1-treatment-of-100-ty-of-clinical-and-healthcare-waste
    #go back
    And I select a different permit from the task list page
    And I select Standard rules as the permit type
    And I select Storage or treatment of waste - recycling, dredgings, clinical, soil or wood treatment as the permit category
    ...
    And I check 2,641 on Cost and processing time page
    And I confirm I meet the rules https://www.gov.uk/government/publications/sr2010-number-12
    #go back
    And I select a different permit from the task list page
    And I select Standard rules as the permit type
    And I select Storage or treatment of waste - recycling, dredgings, clinical, soil or wood treatment as the permit category
    ...
    And I check 3,926 on Cost and processing time page
    And I confirm I meet the rules https://www.gov.uk/government/publications/sr2015-no23-treatment-of-waste-wood-for-recovery
#go back
    And I select a different permit from the task list page
    And I select Standard rules as the permit type
    And I select Storage or treatment of waste - recycling, dredgings, clinical, soil or wood treatment as the permit category
    ...
    And I check 3,926 on Cost and processing time page
    And I confirm I meet the rules https://www.gov.uk/government/publications/sr2015-no24-use-of-waste-to-manufacture-timber-or-construction-products
    #go back
    And I select a different permit from the task list page
    And I select Standard rules as the permit type
    ...
    And I check 2,641 on Cost and processing time page
    And I confirm I meet the rules https://www.gov.uk/government/publications/sr2008-no9-asbestos-waste-transfer-station
    #go back
    And I select a different permit from the task list page
    And I select Standard rules as the permit type
    And I select Waste transfer station or amenity site with or without treatment as the permit category
    ...
    And I check 3,926 on Cost and processing time page
    And I confirm I meet the rules https://www.gov.uk/government/publications/sr2015-no4-75kte-household-commercial-and-industrial-waste-transfer-station
#go back
    And I select a different permit from the task list page
    And I select Standard rules as the permit type
    And I select Waste transfer station or amenity site with or without treatment as the permit category
    ...
    And I check 3,926 on Cost and processing time page
    And I confirm I meet the rules https://www.gov.uk/government/publications/sr2015-no9-household-commercial-and-industrial-waste-transfer-station-with-asbestos-storage-no-building
    #go back
    And I select a different permit from the task list page
    And I select Standard rules as the permit type
    And I select Waste transfer station or amenity site with or without treatment as the permit category
    ...
    And I check 3,926 on Cost and processing time page
    And I confirm I meet the rules https://www.gov.uk/government/publications/sr2015-no6-75kte-household-commercial-and-industrial-waste-transfer-station-with-treatment
    #go back
    And I select a different permit from the task list page
    And I select Standard rules as the permit type
    And I select Waste transfer station or amenity site with or without treatment as the permit category
    ...
    And I check 3,926 on Cost and processing time page
    And I confirm I meet the rules https://www.gov.uk/government/publications/sr2015-no7-household-commercial-and-industrial-waste-transfer-station-with-treatment-no-building
#go back
    And I select a different permit from the task list page
    And I select Standard rules as the permit type
    And I select Waste transfer station or amenity site with or without treatment as the permit category
    ...
    And I check 3,926 on Cost and processing time page
    And I confirm I meet the rules https://www.gov.uk/government/publications/sr2015-no10-75kte-household-commercial-and-industrial-waste-transfer-station-with-treatment-and-asbestos-storage
    #go back
    And I select a different permit from the task list page
    And I select Standard rules as the permit type
    And I select Waste transfer station or amenity site with or without treatment as the permit category
    ...
    And I check 3,926 on Cost and processing time page
    And I confirm I meet the rules https://www.gov.uk/government/publications/sr2015-no11-household-commercial-and-industrial-waste-transfer-station-with-treatment-and-asbestos-storage-no-building
    #go back
    And I select a different permit from the task list page
    And I select Standard rules as the permit type
    And I select Waste transfer station or amenity site with or without treatment as the permit category
    ...
    And I check 3,926 on Cost and processing time page
    And I confirm I meet the rules https://www.gov.uk/government/publications/sr2015-no20-75kte-non-hazardous-and-hazardous-household-waste-amenity-site
#go back
    And I select a different permit from the task list page
    And I select Standard rules as the permit type
    And I select Waste transfer station or amenity site with or without treatment as the permit category
    ...
    And I check 3,926 on Cost and processing time page
    And I confirm I meet the rules https://www.gov.uk/government/publications/sr2015-no19-75kte-non-hazardous-household-waste-amenity-site
    #go back
    And I select a different permit from the task list page
    And I select Standard rules as the permit type
    And I select Metal recycling, scrap metal and WEEE - not cars or vehicles as the permit category
    ...
    And I check 3,926 on Cost and processing time page
    And I confirm I meet the rules https://www.gov.uk/government/publications/sr2015-no3-metal-recycling-and-weee-authorised-treatment-facility-excluding-ozone-depleting-substances
    #go back
    And I select a different permit from the task list page
    And I select Standard rules as the permit type
    And I select Storage or treatment of waste - recycling, dredgings, clinical, soil or wood treatment as the permit category
    ...
    And I check 3,926 on Cost and processing time page
    And I confirm I meet the rules https://www.gov.uk/government/publications/sr2015-no22-materials-recycling-facility-no-building
#go back
    And I select a different permit from the task list page
    And I select Standard rules as the permit type
    And I select Waste transfer station or amenity site with or without treatment as the permit category
    ...
    And I check 3,926 on Cost and processing time page
    And I confirm I meet the rules https://www.gov.uk/government/publications/sr2015-no5-household-commercial-and-industrial-waste-transfer-station-no-building
    #go back
    And I select a different permit from the task list page
    And I select Standard rules as the permit type
    And I select Waste transfer station or amenity site with or without treatment as the permit category
    ...
    And I check 3,926 on Cost and processing time page
    And I confirm I meet the rules https://www.gov.uk/government/publications/sr2015-no8-75kte-household-commercial-and-industrial-waste-transfer-station-with-asbestos-storage